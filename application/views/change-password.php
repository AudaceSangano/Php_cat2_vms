                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal" name="changepassword" onsubmit="return checkpass();">
											...
											foreach($pass as $row) {
												?>
											<input type="hidden" value="<?php echo $row->Password  ?>" name="old">
											<?php
											}
											?>
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="password" id="currentpassword" name="currentpassword" value="" placeholder="old Password" class="form-control" required="">
                                        ...
                                        <p style="text-align: center;"><input type="submit" name="submit" id="submit" class="btn btn-primary btn-sm" value="Change">
                                        </input></p>
